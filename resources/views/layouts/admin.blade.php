                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <x-nav-link :href="route('admin.disputes.index')" :active="request()->routeIs('admin.disputes.*')" class="text-gray-300 hover:text-white">
                                    {{ __('Disputes') }}
                                </x-nav-link>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            <!-- Back to Site -->
                            <a href="{{ route('dashboard') }}" class="text-gray-300 hover:text-white text-sm mr-4">
                                ← Back to Site
                            </a>
