                ...
                <div class="p-6">
                    ...
                    @if($order->status === 'pending')
                        <div class="mt-6 flex items-center space-x-4">
                            ...
                            <a href="{{ route('messages.show', $order) }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition">
